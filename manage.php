...
<html lang="zxx">
   <head>
      <title>Hotel Myriad | Manage</title>
      <meta charset="UTF-8">
			...
			<div class="contact_grid_right">
				<form>
					<div class="contact_left_grid">
						...
						<a href="add.php"><input class="form-control" type="button" value="ADD"></a>
						
						<a href="remove.php"><input class="form-control" type="button" value="REMOVE"></a>
						
						<a href="edit.php"><input class="form-control" type="button" value="EDIT"></a>
						
						<a href="adminlogout.php"><input class="form-control" type="button" value="LOG OUT"></a>
