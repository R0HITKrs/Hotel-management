		...
		<div class="container py-md-3">
		 <div class="w3-head-all mb-3 w3-head-col">
			...
			<div class="contact_grid_right">
				<form action="addaction.php" method="post" onsubmit="u()">
					<div class="contact_left_grid">
						...
						<div class="form-group">
							<input class="form-control" type="text" name="phn" placeholder="Phone Number" maxlength="10" required>
						</div>
