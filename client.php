...
<html lang="zxx">
   <head>
      <title>Hotel Myriad | Bookings</title>
      <meta charset="UTF-8">
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse justify-content-center pr-md-4" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" style="font-weight:bold; color:red;" href="admin.php" >ADMIN</a>
						</li>
					</ul>
				</div>
			</nav>
...
<!--//Slider-->
      <!-- //banner -->
	  	...
	  	<!-- Appointment -->
<section class="appointment py-5" id="manager">
		 ...
		 <div class="w3-head-all mb-3 w3-head-col">
				...
				<?php
					...
					if($result=mysqli_query($link,$sql))
					{
						...
						{
							echo"<table border=1px cellpadding=15 cellspacing=5 bordercolor=white>";
								echo"<tr>";
							...
							{					
								...
								echo"<td>".$row['type']." Room</td>";
								echo"<td>".$row['date']."</td>";
								echo"<td><a href=change.php?id=$row[id]><button style=color:white;background-color:red;border:2px;border-style:solid;border-color:red;font-size:18px;border-radius:8px;>Reply</button></a></td>";
								echo"</tr>";
							}
							echo"</table>";
						}
