...
<html lang="zxx">
   <head>
      <title>Hotel Myriad | Login</title>
      <meta charset="UTF-8">
...
<!--//Slider-->
      <!-- //banner -->
	  	...
	  	<!-- Appointment -->
<section class="appointment py-5" id="login">
		...
		<div class="container py-md-3">
		 ...
		 <div class="w3-head-all mb-3 w3-head-col">
			...
			<div class="contact_grid_right">
					...
					<form  method="post">
						<a href="book.php"><input class="form-control" type="button" value="BOOK A ROOM"></a>
						<a href="checkchanges.php"><input class="form-control" type="button" value="CHECK BOOKINGS"></a>
						<a href="clientout.php"><input class="form-control" type="button" value="LOGOUT"></a>
					</div>
				</form>
			</div>
		</div>
