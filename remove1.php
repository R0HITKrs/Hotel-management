...
<html lang="zxx">
   <head>
      <title>Hotel Myriad | Remove</title>
      <meta charset="UTF-8">
...
$id=$_POST['id'];
$sql="SELECT * FROM m_data WHERE id=".$id." ";
if($result=mysqli_query($link,$sql))
{
	if(mysqli_num_rows($result)>0)
	{
		echo"<section class=appointment py-5 id=appointment>
	<div class=test_agile_info>
		<div class=container py-md-3>
		 <div class=head-edit>
		         <h3>REMOVE MANAGER DETAILS</h3>
		       </div>
			<div class=contact_grid_right>
		
					<form action=removeaction.php method=post onsubmit=u(); style=padding-bottom:70px;>
					<div class=contact_left_grid>";
	
	while($row=mysqli_fetch_array($result))
	{
	
		echo "<div class=contact_grid_right>
					...
					<div class=contact_left_grid>
						...
						<div class=form-group>
							<input class=form-control type=text name=phn value=".$row['phn'].">
						</div>
					...
					<div id=snackbar>REMOVED SUCCESSFULLY</div>
				</form>
			</div>
		</div>
	</div>
